  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 py-24 text-center z-10">
        ...
        >
          What We Do at Velocity Interior
        </h1>
        <p
          ref={subheadingRef}
          className="text-xl md:text-2xl text-white max-w-3xl mx-auto font-light will-change-transform"
        >
          We craft beautiful, functional spaces with precision, creativity, and
          cutting-edge tech — redefining interiors one room at a time.
        </p>
      </div>
    </section>
  );
